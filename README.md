...
<p>このリポジトリは、curlコマンドにheadオプションを付与して実行して、指定したページのヘッダーを取得します</p>
</div>
...
<div class="wp-block-group">
<p>curlコマンドを実行してページのヘッダー情報を取得して表示してみてください</p>
...
<div class="wp-block-group">
<pre class="wp-block-own-copy-code-line-block wp-block-code has-24292-eff-color has-cyan-bluish-gray-background-color has-text-color has-background has-1-125-rem-font-size"><code>curl --head https://ss523971.stars.ne.jp/todo/hello/</code></pre>
